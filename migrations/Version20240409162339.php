 ...
 */
final class Version20240409162339 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE document (id INT AUTO_INCREMENT NOT NULL, equipement_id INT NOT NULL, name VARCHAR(255) NOT NULL, file VARCHAR(255) NOT NULL, INDEX IDX_D8698A76806F0F5C (equipement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE intervention (id INT AUTO_INCREMENT NOT NULL, tech_id INT NOT NULL, date DATE NOT NULL, time TIME NOT NULL, contact TINYINT(1) DEFAULT NULL, type VARCHAR(100) DEFAULT NULL, resolved VARCHAR(50) DEFAULT NULL, canceled VARCHAR(20) DEFAULT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_D11814AB64727BFC (tech_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE picture (id INT AUTO_INCREMENT NOT NULL, equipement_id INT NOT NULL, name VARCHAR(255) NOT NULL, file VARCHAR(255) NOT NULL, INDEX IDX_16DB4F89806F0F5C (equipement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE picture ADD CONSTRAINT FK_16DB4F89806F0F5C FOREIGN KEY (equipement_id) REFERENCES equipement (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE picture DROP FOREIGN KEY FK_16DB4F89806F0F5C');
